...
namespace Microsoft.NET.Sdk.Razor.Tests
{
    public class StaticWebAssetsIntegrationTest : SdkTest
    {
        ...
        public void Publish_CopiesStaticWebAssetsToDestinationFolder()
        {
            ...
            new FileInfo(Path.Combine(publishOutputPath, Path.Combine("wwwroot", "_content", "AnotherClassLib", "css", "site.css"))).Should().Exist();
            new FileInfo(Path.Combine(publishOutputPath, Path.Combine("wwwroot", "_content", "AnotherClassLib", "js", "project-direct-dep.js"))).Should().Exist();
        ...
        public void Publish_CopiesStaticWebAssetsToDestinationFolder_PublishSingleFile()
        {
            ...
            new FileInfo(Path.Combine(publishOutputPathWithRID, Path.Combine("wwwroot", "_content", "AnotherClassLib", "css", "site.css"))).Should().Exist();
            new FileInfo(Path.Combine(publishOutputPathWithRID, Path.Combine("wwwroot", "_content", "AnotherClassLib", "js", "project-direct-dep.js"))).Should().Exist();
        ...
        public void Publish_NoBuild_CopiesStaticWebAssetsToDestinationFolder()
        {
            ...
            var publish = new PublishCommand(Log, Path.Combine(projectDirectory.TestRoot, "AppWithPackageAndP2PReference"));
            publish.Execute("/p:NoBuild=true", "/bl:/Users/captainsafia/Downloads/a.binlog").Should().Pass();
